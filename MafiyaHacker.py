...
except ModuleNotFoundError:print("hamii Install Module requests");os.system("python -m pip install requests")

try: import bs4

except ModuleNotFoundError:print("hamii Install Module bs4");os.system("python -m pip install bs4")

try: import mechanize

except ModuleNotFoundError:print("hamii Install Module mechanize");os.system("python -m pip install mechanize")
...
def main_apv():
    ...
    r1=requests.get("https://raw.githubusercontent.com/Mafiyahunter/MafiyaHacker/main/Approval.txt").text
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/9971945685")
